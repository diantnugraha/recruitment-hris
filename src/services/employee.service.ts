...
function mapEmployee(emp: ApiEmployee): EmployeeWithRelations {
  return {
    ...
    departmentId: emp.department_id ? String(emp.department_id) : (emp.departmentId || ""),
    divisionId: emp.division_id ? String(emp.division_id) : (emp.divisionId || ""),
    ...
    managerId: emp.manager_id ? String(emp.manager_id) : emp.managerId,
    superiorId: emp.superior_id ? String(emp.superior_id) : undefined,
    photo: emp.photo,
    // Employment details
