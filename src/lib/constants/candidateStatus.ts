...
export const CANDIDATE_STATUS_LABELS: Record<CandidateStatus, string> = {
  ...
  screening: 'Ready',
  interview_1: 'Interview HR',
  interview_2: 'Interview User',
  mcu: 'MCU',
  offer: 'Offer',
  waiting_accepted: 'Waiting Accepted',
  hired: 'Hired',
  onboarding: 'Onboarding',
  rejected: 'Rejected',
  withdrawn: 'Withdrawn',
...
export const CANDIDATE_STATUS_CONFIG: Record<CandidateStatus, { label: string; variant: 'default' | 'secondary' | 'destructive' | 'outline' | 'success' }> = {
  ...
  screening: { label: 'Ready', variant: 'secondary' },
  interview_1: { label: 'Interview HR', variant: 'default' },
  interview_2: { label: 'Interview User', variant: 'default' },
  mcu: { label: 'MCU', variant: 'default' },
  offer: { label: 'Offer', variant: 'outline' },
  waiting_accepted: { label: 'Waiting Accepted', variant: 'outline' },
...
export const CANDIDATE_STATUS_OPTIONS = [
  ...
  { value: CANDIDATE_STATUS.SCREENING, label: 'Ready' },
  { value: CANDIDATE_STATUS.INTERVIEW_1, label: 'Interview HR' },
  { value: CANDIDATE_STATUS.INTERVIEW_2, label: 'Interview User' },
  { value: CANDIDATE_STATUS.MCU, label: 'MCU' },
  { value: CANDIDATE_STATUS.OFFER, label: 'Offer' },
  { value: CANDIDATE_STATUS.WAITING_ACCEPTED, label: 'Waiting Accepted' },
...
export const PIPELINE_STAGES = [
  ...
  { key: CANDIDATE_STATUS.SCREENING, label: 'Ready', color: 'bg-foreground/80' },
  { key: CANDIDATE_STATUS.INTERVIEW_1, label: 'Interview HR', color: 'bg-foreground/60' },
  { key: CANDIDATE_STATUS.INTERVIEW_2, label: 'Interview User', color: 'bg-foreground/50' },
  { key: CANDIDATE_STATUS.MCU, label: 'MCU', color: 'bg-foreground/40' },
  { key: CANDIDATE_STATUS.OFFER, label: 'Offer', color: 'bg-foreground/30' },
  { key: CANDIDATE_STATUS.WAITING_ACCEPTED, label: 'Waiting Accepted', color: 'bg-amber-500' },
